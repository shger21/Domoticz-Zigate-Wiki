...
| DanfossCovered | 'F' or 'T': 'T' indicates radiator is covered | Danfoss eTRV thermostat will be set into "Room Sensor Mode" if radiator is covered, and thermostat will use only external temperature sensor for room temperature |
